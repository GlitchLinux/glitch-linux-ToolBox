...
# Define Ventoy URL & Tails OS download-link and file paths
...
iso_filename="tails-amd64-6.9.iso"
iso_url="https://download.tails.net/tails/stable/tails-amd64-6.9/tails-amd64-6.9.iso"
...
# Create a 2GB .img file
img_path="/tmp/ventoy.img"
dd if=/dev/zero of="$img_path" bs=1M count=2000
...
# Download Tails OS ISO to Ventoy exFAT partition
